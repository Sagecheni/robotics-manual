...
> [!NOTE]  
> *该部分展示的用法属于无脑跟做版，想了解更多信息以及为什么要这么做，请跳转到 一些说明 部分*
...
2. 在宿主机安装 Docker engine（**不是Docker Desktop！！！**）
   ...
   如果是在windows下启动本容器则需要 Docker Desktop，请跳转到

3. 点击 “use this template”，创建你自己的存储库

    Click on "use this template"，Create your repository  
    
    https://www.notion.so/image/attachment%3Aa9810d2e-789c-4868-8b2d-2a59202b54b7%3Aimage.png?table=block&id=1e1acf4c-6a7d-8099-90cb-edc9530b6344&spaceId=70ba0715-0ac1-41ec-9eda-74872a765d7d&width=2000&userId=771dafe8-dc78-4d2c-8f81-51c6b4bd0acd&cache=v2
